--[[
	...
	This distribution:
	* Has a global 'geo2d' table containing all functions
...
do
	...
	* Hull and Bounds  
	...
	function M.intersection_point_aabb_aabb(a_min_x, a_min_y, a_max_x, a_max_y, b_min_x, b_min_y, b_max_x, b_max_y)
		...
		local _x1, _y1, _x2, _y2, _x3, _y3, _x4, _y4 	local function _add_point(_px, _py)
	...
	function M.intersection_point_aabb_line(min_x, min_y, max_x, max_y, x1, y1, x2, y2)
		...
		local _x1, _y1, _x2, _y2 	local function _add_point(_px, _py)
			if _x1 == nil or (_px == _x1 and _py == _y1) then
				_x1, _y1 = _px, _py
			elseif _x2 == nil or (_px == _x2 and _py == _y2) then
				_x2, _y2 = _px, _py
	...
	function M.intersection_point_ray_aabb(ray_x, ray_y, ray_dx, ray_dy, min_x, min_y, max_x, max_y)
		...
		if tmin < tmax then
			local px, py 		if greater_than_or_equal(tmin, 0) then
	...
	function M.intersection_point_segment_triangle(seg_x1, seg_y1, seg_x2, seg_y2, tri_x1, tri_y1, tri_x2, tri_y2, tri_x3,
		...
		local px, py 
		local ix, iy = M.intersection_point_segment_segment(seg_x1, seg_y1, seg_x2, seg_y2, tri_x1, tri_y1, tri_x2, tri_y2) 	if ix and iy then
			px, py = ix, iy
		end
	
		ix, iy = M.intersection_point_segment_segment(seg_x1, seg_y1, seg_x2, seg_y2, tri_x2, tri_y2, tri_x3, tri_y3) 	if ix and iy then
			if not px then
				px, py = ix, iy
			else
				return px, py, ix, iy
		...
		ix, iy = M.intersection_point_segment_segment(seg_x1, seg_y1, seg_x2, seg_y2, tri_x3, tri_y3, tri_x1, tri_y1) 	if ix and iy then
			if not px then
				return ix, iy
			else
				return px, py, ix, iy
	...
	function M.intersection_point_triangle_circle(tri_x1, tri_y1, tri_x2, tri_y2, tri_x3, tri_y3, cx, cy, radius)
		...
		local _x1, _y1, _x2, _y2, _x3, _y3, _x4, _y4, _x5, _y5, _x6, _y6 	local function _add_point(_px, _py)
			if _x1 == nil or (_px == _x1 and _py == _y1) then
				_x1, _y1 = _px, _py
			elseif _x2 == nil or (_px == _x2 and _py == _y2) then
				_x2, _y2 = _px, _py
	...
	function M.intersection_point_quad_circle(quad_x1, quad_y1, quad_x2, quad_y2, quad_x3, quad_y3, quad_x4, quad_y4, cx, cy, radius)
		...
		local _x1, _y1, _x2, _y2, _x3, _y3, _x4, _y4, _x5, _y5, _x6, _y6, _x7, _y7, _x8, _y8 	local function _add_point(_px, _py)
			if _x1 == nil or (_px == _x1 and _py == _y1) then
				_x1, _y1 = _px, _py
			elseif _x2 == nil or (_px == _x2 and _py == _y2) then
				_x2, _y2 = _px, _py
	...
	function M.point_of_reflection(sx1, sy1, sx2, sy2, p1x, p1y, p2x, p2y)
		...
		then
			...
			local ix, iy = M.intersection_point_segment_segment(p1x, p1y, p2px, p2py, p2x, p2y, p1px, p1py) 		if ix and iy then
	...
	function M.triangle_indices_from_polygon(polygon, prefer_equilateral_triangles)
		...
		local indices = {} 	for i = 1, #polygon/2 do
